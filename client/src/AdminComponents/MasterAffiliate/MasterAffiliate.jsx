...
const MasterAffiliate = () => {
  ...
  useEffect(() => {
    ...
    const fetchDownlineStats = async () => {
      try {
        // API call using referralCode in URL (no headers needed)
  ...
  const stats = [
    ...
    },
    {
      ...
      value: loading ? "Loading..." : `${downlineStats.todayPlayerWin} BDT`,
      gradient: "from-orange-500 via-pink-500 to-red-500",
    },
    {
      title: "Today My Player Loss",
      value: loading ? "Loading..." : `${downlineStats.todayPlayerLoss} BDT`,
